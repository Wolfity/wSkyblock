...
public class MainGUI extends SkyblockGUI {
    ...
    public MainGUI(final SkyblockPlugin plugin, final SkyblockPlayer owner) {
        ...
        setItem(13, plugin.getMagicMarketManager().getMagicMarket().getIcon(), player -> new MagicMarketGUI(plugin, owner, plugin.getMagicMarketManager().getMagicMarket(), 1));
        setItem(21, ItemUtils.createItem(Material.DIAMOND_SWORD, "&cSkills"), player -> new SkillGUI(plugin, owner));
        ...
        setItem(23, ItemUtils.createItem(Material.DIAMOND, "&bShop"), player -> new ShopGUI(plugin, owner));
        setItem(31, ItemUtils.createItem(Material.DARK_OAK_BOAT, "&aAuction House"), player -> new AuctionGUI(owner, plugin.getAuctionManager().getAuctionHouse(), 1, plugin));
